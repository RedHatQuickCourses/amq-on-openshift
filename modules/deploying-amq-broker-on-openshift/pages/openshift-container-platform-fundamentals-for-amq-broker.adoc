...
.Pod Diagram
image::amq-broker-pod.png[AMQ Broker Pod,width=600,align=center]
_Figure: A single AMQ Broker instance running inside a Pod._
...
.Service Diagram
image::amq-broker-service.png[AMQ Broker Service,width=600,align=center]
_Figure: A Service providing stable access to AMQ Broker Pods._
...
.Persistence Diagram
image::amq-broker-persistence.png[AMQ Broker Persistence,width=600,align=center]
_Figure: AMQ Broker using Persistent Volume Claim for durable storage._
...
.Operator Diagram
image::amq-broker-operator.png[AMQ Broker Operator,width=600,align=center]
_Figure: The AMQ Broker Operator managing Broker Custom Resources and underlying OpenShift resources._
...
[source,bash]
----
oc new-app --docker-image=nginx:latest --name=my-nginx
----
+
