...
[source,bash]
----
$ cd ~/broker/operator/amq-broker-operator-7.14.0-ocp-install-examples
----
...
. Lab environment provided with this course has `~/.kube/config` file which authenticates you as `admin` user.
...
FIXME: Steps performed in the lab
----
[lab-user@bastion deploy]$ oc create -f service_account.yaml 
serviceaccount/amq-broker-controller-manager created


[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc create -f deploy/role.yaml 
role.rbac.authorization.k8s.io/amq-broker-operator-role created


[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc create -f deploy/role_binding.yaml 
rolebinding.rbac.authorization.k8s.io/amq-broker-operator-rolebinding created


[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc create -f deploy/crds/broker_activemqartemis_crd.yaml 
customresourcedefinition.apiextensions.k8s.io/activemqartemises.broker.amq.io created
[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc create -f deploy/crds/broker_activemqartemisaddress_crd.yaml 
customresourcedefinition.apiextensions.k8s.io/activemqartemisaddresses.broker.amq.io created
[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc create -f deploy/crds/broker_activemqartemisscaledown_crd.yaml 
customresourcedefinition.apiextensions.k8s.io/activemqartemisscaledowns.broker.amq.io created


[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc get secrets 
NAME                                            TYPE                      DATA   AGE
amq-broker-controller-manager-dockercfg-pbjps   kubernetes.io/dockercfg   1      7m27s
builder-dockercfg-2xpxw                         kubernetes.io/dockercfg   1      19m
default-dockercfg-5x24r                         kubernetes.io/dockercfg   1      19m
deployer-dockercfg-thw6v                        kubernetes.io/dockercfg   1      19m
[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ 
[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc secrets link --for=pull default default-dockercfg-5x24r
[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc secrets link --for=pull deployer deployer-dockercfg-thw6v
[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc secrets link --for=pull builder builder-dockercfg-2xpxw
[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ 


[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc create -f deploy/operator.yaml
deployment.apps/amq-broker-controller-manager created

[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc get deployment
NAME                            READY   UP-TO-DATE   AVAILABLE   AGE
amq-broker-controller-manager   1/1     1            1           2m35s



[lab-user@bastion amq-broker-operator-7.14.0-ocp-install-examples]$ oc get crd | grep "broker.amq.io"
activemqartemisaddresses.broker.amq.io                            2026-06-05T13:19:48Z
activemqartemises.broker.amq.io                                   2026-06-05T13:18:46Z
activemqartemisscaledowns.broker.amq.io                           2026-06-05T13:20:23Z
----
