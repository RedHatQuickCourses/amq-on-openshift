#  Best Practices for Scaling in OpenShift

Here's the detailed educational content for "Best Practices for Scaling in OpenShift" for AMQ Broker, presented in Antora AsciiDoc format.

```asciidoc
[[_best_practices_scaling_openshift]]
