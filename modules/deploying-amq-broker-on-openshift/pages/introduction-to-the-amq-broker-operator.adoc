...
+
You would typically download this from the Red Hat Customer Portal. For demonstration purposes, assume you've downloaded `amq-broker-operator-7.13.3-ocp-install-examples-rhel9.zip` to your `Downloads` directory.
+
[source,bash]
----
mv ~/Downloads/amq-broker-operator-7.13.3-ocp-install-examples-rhel9.zip .
----
