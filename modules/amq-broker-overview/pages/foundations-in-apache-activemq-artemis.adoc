...
*   *Multi-Protocol Support (Native Implementation)*: Unlike some brokers that rely on protocol converters or proxies, Artemis natively implements a wide range of standard messaging protocols directly into its core. This native support reduces overhead, enhances performance, and provides seamless interoperability. These protocols include:
    ** *AMQ Core Protocol*: The high-performance, low-latency native protocol primarily used by Java clients.
...
[source,bash]
----
2026-06-11 20:09:11,099 INFO  [org.apache.activemq.artemis.integration.bootstrap] AMQ101000: Starting ActiveMQ Artemis Server version 2.40.0.redhat-00009
...........
2026-06-11 20:09:12,011 INFO  [org.apache.activemq.artemis.core.server] AMQ221007: Server is now active
2026-06-11 20:09:12,011 INFO  [org.apache.activemq.artemis.core.server] AMQ221001: Apache ActiveMQ Artemis Message Broker version 2.40.0.redhat-00009 [0.0.0.0, nodeID=9e8121c6-3720-11f1-87d3-047bcb64475b] 
2026-06-11 20:09:12,018 INFO  [org.apache.activemq.artemis] AMQ241003: Starting embedded web server
2026-06-11 20:09:12,320 INFO  [io.hawt.HawtioContextListener] Initialising Hawtio services
2026-06-11 20:09:12,325 INFO  [io.hawt.jmx.JmxTreeWatcher] Welcome to Hawtio 4.3.0.redhat-00010
2026-06-11 20:09:12,331 INFO  [io.hawt.web.auth.AuthenticationConfiguration] Authentication throttling is enabled
2026-06-11 20:09:12,332 INFO  [io.hawt.web.auth.AuthenticationConfiguration] Starting Hawtio authentication filter, JAAS realm: "activemq" authorized role(s): amq, role principal class names: org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal

----

  ** In this output, observe the key indicators: 

    *   The log entry `AMQ221001: Apache ActiveMQ Artemis Message Broker version 2.40.0.redhat-00009` clearly identifies the underlying messaging engine and its specific version. The `.redhat-00009` suffix denotes Red Hat's specific build, indicating it's an enterprise-hardened version.
...
[source,bash]
----    
    $ <broker-instance-dir>/bin/artemis queue create --name exampleQueue --address exampleQueue --auto-create-address --anycast --durable --purge-on-no-consumers=false
----    
